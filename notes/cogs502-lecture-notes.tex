...
that can be divided without remainder only by 1 and themselves.} Define a
...
are required to report any prime number you encounter along the way, except the
final 1. Besides reporting the primes, your program should also report \emph{and
return} the sum of these primes, again except the final 1.
...
element will guaranteed that what is next in the \Verb+OR+ will be evaluated.
